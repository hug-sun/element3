...
describe('radioButton.vue', () => {
  ...
  it('size', async () => {
    ...
    expect(wrapper.findComponent({ name: 'ElRadioButton' }).classes()).toContain(`el-radio-button--mini`)

    await wrapper.setProps({ size: 'small' })
    expect(wrapper.findComponent({ name: 'ElRadioButton' }).classes()).toContain(`el-radio-button--small`)

    await wrapper.setProps({ size: 'medium' })
    expect(wrapper.findComponent({ name: 'ElRadioButton' }).classes()).toContain(`el-radio-button--medium`)
  })
  ...
  it('disabled', async () => {
    ...
    expect(wrapper.findComponent({ name: 'ElRadioButton' }).classes()).toContain(
      'is-disabled'
    )
  ...
  it('is-active', async () => {
    ...
    expect(wrapper.findAllComponents({ name: 'ElRadioButton' })[0].classes()).toContain(
      'is-active'
    )
  })
