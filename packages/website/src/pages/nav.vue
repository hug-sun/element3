...
<template>
  <div>
    ...
    <div class="block">
      <h3>选择合适的导航</h3>
      <p>
        选择合适的导航可以让用户在产品的使用过程中非常流畅，相反若是不合适就会引起用户操作不适（方向不明确），以下是「侧栏导航」和
        「顶部导航」的区别。
      </p>
    </div>
    <div class="block">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="15" class="nav-demos">
          <img
            src="../assets/images/navbar_1.png"
            alt="一级类目"
          ...
          <img
            src="../assets/images/navbar_2.png"
            alt="二级类目"
            @click="enlarge(846, $event)"
          />
          <h5>二级类目</h5>
          ...
          <img
            src="../assets/images/navbar_3.png"
            alt="三级类目"
            @click="enlarge(846, $event)"
          />
    ...
    <div class="block">
      ...
      <el-row>
        ...
        <el-col :span="14" class="nav-demos">
          <img
            src="../assets/images/navbar_0.png"
            alt=""
            @click="enlarge(846, $event)"
          />
