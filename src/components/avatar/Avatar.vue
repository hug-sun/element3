...
const useClasses = function({ props, shape }){
  return computed(() => {
    return [
      shape.value ? `el-avata--${shape.value}` : '',
    ]
  })
}
